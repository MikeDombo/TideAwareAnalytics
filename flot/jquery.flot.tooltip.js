...
(function ($) {
    ...
    FlotTooltip.prototype.init = function (plot) {
        ...
        plot.hooks.bindEvents.push(function (plot, eventHolder) {
			...
			$( plot.getPlaceholder() ).bind("plotclick", plothover);
        ...
        plot.hooks.shutdown.push(function (plot, eventHolder){
			...
			$(plot.getPlaceholder()).unbind("plotclick", plothover);
        ...
        function plothover(event, pos, item) {
            ...
            // Here is some voodoo magic for determining the distance to a line from a given point {x, y}.
